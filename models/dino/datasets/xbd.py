...
from models.dino.datasets.data_util import preparing_dataset
import models.dino.datasets.transforms as T
from models.dino.util.box_ops import box_cxcywh_to_xyxy, box_iou
...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        # Pass the path of the "pseudo_label" json file in the training script instead.
        "train": ("/", pseudo_label),  # new pseudo-label
        # "train": (root / "train/images", pseudo_label ),
        "val": (root / "test/images", root / "annotations" / f'{mode}_test_pre.json'),
        # "train": (root / "train/images", root / "annotations" / f'{mode}_train_pre.json' ),
